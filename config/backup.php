...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_NAME', 'cis4-backups'),
        ...
        'source' => [
            'files' => [
                ...
                'exclude' => [
                    ...
                    base_path('storage/app/private/temp'),
        ...
        'destination' => [
            ...
            'disks' => array_filter([
                'local',
                env('BACKUP_VAULT_FTP_ENABLED', false) ? 'vault_ftp' : null,
            ]),
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_all_backups_for_days' => (int) env('BACKUP_KEEP_DAILY', 7),
             ...
             */
            'keep_daily_backups_for_days' => (int) env('BACKUP_KEEP_DAILY', 7),
             ...
             */
            'keep_weekly_backups_for_weeks' => (int) env('BACKUP_KEEP_WEEKLY', 4),
