...
<div class="max-w-5xl mx-auto sm:px-6 lg:px-8 py-6 px-2 page-container">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">Bug Report #{{ $bugReport->id }}</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <div class="p-6">
                        @if($bugReport->admin_notes)
                            <p class="text-gray-700 whitespace-pre-wrap mb-4">{{ $bugReport->admin_notes }}</p>
                        @else
                            <p class="text-gray-500 italic mb-4">No admin notes yet</p>
                        @endif
                    </div>
                </div>
            @endif
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
                <h3 class="text-sm font-medium text-gray-700 mb-4">Bug Information</h3>
            ...
            @can('update', $bugReport)
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                    <div class="p-6 border-b border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900">Update Bug Report</h3>
                    </div>
                    <form action="{{ route('bug-reports.update', $bugReport) }}" method="POST" class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="admin_notes" name="admin_notes" rows="4" class="no-rich-text w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm" placeholder="Add notes about investigation, fixes, etc.">{{ $bugReport->admin_notes }}</textarea>
                        </div>
