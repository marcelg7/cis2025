    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-6 px-2"> <!-- Added px-2 -->
        ...
        <form method="POST" action="{{ route('commitment-periods.store') }}" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="cancellation_policy" id="cancellation_policy" rows="5" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('cancellation_policy') }}</textarea>
