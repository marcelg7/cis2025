...
<div class="max-w-3xl mx-auto sm:px-6 lg:px-8 py-6 px-2 page-container">
    ...
    <form method="POST" action="{{ route('locations.update', $location) }}" class="bg-white rounded-lg border border-gray-200 shadow-sm">
        @csrf
        @method('PUT')
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                    <div class="flex">
                        ...
                        <div class="ml-3 text-sm text-blue-700">
                            <p>This location has {{ $location->users_count }} {{ Str::plural('user', $location->users_count) }} assigned to it.</p>
                        </div>
                    </div>
                </div>
            @endif
