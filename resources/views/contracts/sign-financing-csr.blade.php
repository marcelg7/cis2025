        ...
        <div class="px-6 py-4">
            ...
            <div wire:ignore x-data="{
                ...
                resizeCanvas() {
                    ...
                    this.signaturePad.clear(); // Clear after resize to avoid distortion
                }
            ...
            <form id="initialsForm" action="{{ route('contracts.financing.store-csr-initial', $contract->id) }}" method="POST" style="display: none;">
                @csrf
