...
<td class="py-3 px-4 text-right">
    <div class="flex justify-end space-x-2">
        ...
        @if(!$contract->ftp_to_vault)
            {{-- Hide these buttons after vault upload since signature files are cleaned up --}}

            <!-- Download - Only for Finalized and NOT uploaded to vault -->
            ...
            <!-- Email - Only for Finalized and NOT uploaded to vault -->
        ...
        <!-- Financing Form - Only for contracts that require financing and NOT uploaded to vault -->
