...
<div class="max-w-4xl mx-auto sm:px-6 lg:px-8 py-6 signature-page-container">
    <div class="mb-6 stagger-item">
        <a href="{{ route('contracts.view', $contract->id) }}" class="inline-flex items-center text-sm text-indigo-600 hover:text-indigo-500 transition-all duration-200 hover:translate-x-1">
